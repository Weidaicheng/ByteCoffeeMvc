...
using ByteCoffee.Utility.Filter;
using System;
...
namespace ByteCoffee.Utility.Extensions
{
    ...
    public static class CollectionExtensions
    {
        ...
        /// <summary>
        /// 从指定IQueryable[T]集合中查询数据集(从旧项目中摘入)
        /// </summary>
        ...
        {
            source.CheckNotNull("source");
            sortConditions.CheckNotNull("sortConditions");
            ...
            if (sortConditions != null && sortConditions.Length > 0)
            {
                ...
                {
                    orderSource = count == 0
                        ? source.OrderBy(sortCondition.SortField, sortCondition.ListSortDirection)
                        : orderSource.ThenBy(sortCondition.SortField, sortCondition.ListSortDirection);
                    count++;
                }
                source = orderSource;
            }
