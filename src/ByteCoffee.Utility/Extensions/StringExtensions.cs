using ByteCoffee.Utility.Secutiry;
...
namespace ByteCoffee.Utility.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// <param name="ellipsisWords">补齐位数的字符.</param>
        /// <returns></returns>
        public static string PaddingWords(this string originalStr, int render_front, int render_foot, char ellipsisWords = '*')
        {
            ...
            return string.Format("{0}{1}{2}", originalStr.Substring(0, render_front),
                ("").PadLeft(originalStr.Length - render_foot - render_front, ellipsisWords),
        ...
        /// <returns></returns>
        public static string PaddingWords(this string originalStr, int render_front, int render_foot, int ellipsisCount, char ellipsisWords = '*')
        {
            if (string.IsNullOrEmpty(originalStr))
            { return string.Empty; }
            if (originalStr.Length < (render_front + render_foot))
            ...
            return string.Format("{0}{1}{2}", originalStr.Substring(0, render_front),
                ("").PadLeft(ellipsisCount, ellipsisWords),
                originalStr.Substring(originalStr.Length - render_foot));
        }
        ...
        /// <returns></returns>
        public static string RemoveBlank(this string txt)
        ...
        /// 字符串转化为Base64码
        /// </summary>
        /// <param name="PlainTxt">The plain text.</param>
        /// <param name="_Encoding">The encoding.</param>
        /// <returns></returns>
        public static string ToBase64(this string PlainTxt, Encoding _Encoding)
        {
            byte[] b = _Encoding.GetBytes(PlainTxt); //System.Text.Encoding.UTF8.GetBytes(PlainTxt);
            string resultStr = Convert.ToBase64String(b);
            return resultStr;
        }
        ...
        /// <param name="_Encoding">The encoding.</param>
        /// <returns></returns>
        public static string FromBase64(this string Base64Str, Encoding _Encoding)
        {
            byte[] c = Convert.FromBase64String(Base64Str);
            string resultStr = _Encoding.GetString(c); //System.Text.Encoding.UTF8.GetString(c);
            return resultStr;
        }
        ...
        /// URL字符串转化为base64码
        /// </summary>
        /// <param name="UrlStr">The plain text.</param>
        /// <param name="_Encoding">The encoding.</param>
        /// <returns></returns>
        public static string ToBase64ForUrl(this string UrlStr, Encoding _Encoding)
        {
            byte[] b = _Encoding.GetBytes(UrlStr); //System.Text.Encoding.UTF8.GetBytes(PlainTxt);
            string resultStr = Convert.ToBase64String(b).Replace('+', '*').Replace('/', '-').Replace('=', '.');
            return resultStr;
        }
        ...
        /// base64码转化为Url字符串
        /// </summary>
        /// <param name="Base64UrlStr">The base64 string.</param>
        /// <param name="_Encoding">The encoding.</param>
        /// <returns></returns>
        public static string FromBase64ForUrl(this string Base64UrlStr, Encoding _Encoding)
        {
            string ModifyInputTxt = Base64UrlStr.Replace('.', '=').Replace('*', '+').Replace('-', '/');
            byte[] c = Convert.FromBase64String(ModifyInputTxt);
            string resultStr = _Encoding.GetString(c); //System.Text.Encoding.UTF8.GetString(c);
            return resultStr;
        }
